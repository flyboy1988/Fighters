...
import com.flyboy.fighters.databinding.FighterVideoTmelineListBinding
import com.flyboy.fighters.model.MediaObject
import com.flyboy.fighters.utils.PlayerStateCallback
import com.flyboy.fighters.utils.PlayerViewAdapter.Companion.releaseRecycledPlayers
import com.google.android.exoplayer2.Player
import java.util.ArrayList

class FighterVideosRecyclerAdapter(
    ...
    override fun onCreateViewHolder(
        ...
        val binding: FighterVideoTmelineListBinding = DataBindingUtil.inflate(
            LayoutInflater.from(viewGroup.context)
            , R.layout.fighter_video_tmeline_list, viewGroup, false)
    ...
    inner class VideoPlayerViewHolder(private val binding: FighterVideoTmelineListBinding) : RecyclerView.ViewHolder(binding.root) {
        fun onBind(model: MediaObject) {
            ...
            binding.apply {
                dataModel = model
                callback = this@FighterVideosRecyclerAdapter
