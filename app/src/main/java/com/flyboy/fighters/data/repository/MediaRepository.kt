...
class MediaRepository {
     fun getMediaData(): MutableLiveData<MutableList<MediaObject>> {
        val data: MutableLiveData<MutableList<MediaObject>> = MutableLiveData()
        val dataObservable = mutableListOf(
            MediaObject(
                "F16",
                "https://vimeo.com/user132394489/review/506306880/cdbf87b598",
